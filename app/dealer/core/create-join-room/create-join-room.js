var CreateJoinRoomDirective = function () {
    return {
        restrict: 'E',
...
var CreateJoinRoomController = /** @class */ (function () {
    function CreateJoinRoomController($scope, $location, $http, serverURL, initData) {
